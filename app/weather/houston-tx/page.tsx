...
const cityData: { [key: string]: { 
  ...
  'houston-tx': {
    ...
    title: 'Houston Weather Forecast | 16-Bit Retro Weather Terminal',
    description: 'Get Houston weather in nostalgic 16-bit style. Real-time conditions, 7-day forecast, radar, and atmospheric data.',
    content: {
          ...
          <div className="container mx-auto px-4 py-8">
            ...
            <div className="text-center mb-6">
              ...
              <p className={cn(
                ...
                Houston has a humid subtropical climate with hot, humid summers year-round. The city is prone to tropical weather systems from the Gulf.
              </p>
            </div>
            ...
            >
              <ul className="space-y-2">
                <li>• Gulf moisture creates frequent afternoon thunderstorms</li>
                <li>• Hurricane season brings potential for major storm impacts</li>
                <li>• High humidity makes summer temperatures feel 10+ degrees hotter</li>
              </ul>
            </CollapsibleSection>
          </div>
        </div>
