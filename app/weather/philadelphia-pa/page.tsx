...
const cityData: { [key: string]: { 
  ...
  'philadelphia-pa': {
    ...
    title: 'Philadelphia Weather Forecast | 16-Bit Retro Weather Terminal',
    description: 'Get Philadelphia weather in nostalgic 16-bit style. Real-time conditions, 7-day forecast, radar, and atmospheric data.',
    content: {
          ...
          <div className="container mx-auto px-4 py-8">
            ...
            <div className="text-center mb-6">
              ...
              <p className={cn(
                ...
                Philadelphia has a humid subtropical climate with hot summers and cool winters. The city experiences four distinct seasons with moderate precipitation.
              </p>
            </div>
            ...
            >
              <ul className="space-y-2">
                <li>• Nor'easter storms bring heavy winter snow and rain</li>
                <li>• Urban heat island effect moderates winter temperatures</li>
                <li>• Delaware River valley influences local weather patterns</li>
              </ul>
            </CollapsibleSection>
          </div>
        </div>
