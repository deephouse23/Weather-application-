...
const cityData: { [key: string]: { 
  ...
  'san-antonio-tx': {
    ...
    title: 'San Antonio Weather Forecast | 16-Bit Retro Weather Terminal',
    description: 'Get San Antonio weather in nostalgic 16-bit style. Real-time conditions, 7-day forecast, radar, and atmospheric data.',
    content: {
          ...
          <div className="container mx-auto px-4 py-8">
            ...
            <div className="text-center mb-6">
              ...
              <p className={cn(
                ...
                San Antonio has a humid subtropical climate with hot summers and mild winters. The city experiences warm weather most of the year.
              </p>
            </div>
            ...
            >
              <ul className="space-y-2">
                <li>• Hill Country location creates slight elevation cooling</li>
                <li>• Gulf moisture brings summer afternoon thunderstorms</li>
                <li>• Occasional winter freezes can damage local vegetation</li>
              </ul>
            </CollapsibleSection>
          </div>
        </div>
