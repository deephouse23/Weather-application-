...
import { Menu, X, Home, Map, Plane, GraduationCap, Gamepad2, Newspaper, Sparkles, Sun, Thermometer, ChevronDown, Cloud, Wrench, AlertTriangle, CloudLightning, Snowflake, CloudRain, Route, Info, FileText } from "lucide-react"
