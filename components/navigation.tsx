      ...
      <div className="hidden md:flex items-center justify-between px-6 py-4">
        ...
        <div className="relative">
          <button
            ...
            className="flex items-center justify-center space-x-2 px-3 py-2 border-2 text-xs font-mono font-bold uppercase tracking-wider transition-all duration-200 min-w-[120px] h-[32px]"
            style={{
              borderColor: themeColors.border,
              backgroundColor: themeColors.background,
