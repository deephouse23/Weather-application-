...
opener_hash: c321779f
key_phrases:
  - sixty-seven confirmed tornadoes in seven days
  - six separate tornado warnings in roughly 25 minutes across three states
  - hail-dominant outbreaks tend to correlate with more discrete supercell modes rather than linear squall lines
  - 509 hail reports against 356 wind reports is a ratio worth noting
  - "trough-induced moisture return that drove last week's outbreak"
  - 8.42 inches in seven days would rank among the wettest weeks on record for the Dallas-Fort Worth area
  - "treat the May 1 window as a watch period, not a weather curiosity"
  - the ridge over the West Coast is effectively a lid
  - "warmer than Chicago's 55°F — which reflects a persistent Atlantic pattern that has kept western Europe mild while the U.S. Midwest sits under cooler, unsettled flow"
  - a corridor that lit up almost continuously through the back half of the week
similarity_max: 0
...
![Hurricane Katrina at peak intensity, August 28, 2005.](https://commons.wikimedia.org/wiki/Special:FilePath/Hurricane_Katrina_August_28_2005_NASA.jpg?width=1280)
*NASA*
...
![OVATION model aurora forecast for the northern hemisphere.](https://services.swpc.noaa.gov/images/animations/ovation/north/latest.jpg)
*NOAA SWPC*
