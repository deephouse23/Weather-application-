...
tags:
  ...
  - aviation
  - atmosphere-layers
heroImage: "https://commons.wikimedia.org/wiki/Special:FilePath/Jetstreamconfig.jpg?width=1280"
readTime: 5
cadence: wednesday_topic
opener_hash: c006fa59
key_phrases:
  - sulfate aerosol veil detectable from pole to pole
  - the real climate actor is sulfur dioxide
  - above the weather layer
  - diffuse light penetrates canopy gaps that direct sunlight never reaches
  - termination shock if injection stops abruptly
  - tiered ash concentration zones rather than a binary keep-out boundary
  - "Munch's The Scream as a plausible artistic record of aerosol scattering"
  - an eruption that peaks at 18 km versus 25 km
  - "Hunga Tonga injected an unprecedented volume of water vapor — not SO2"
  - volcanic cooling is not the mirror image of greenhouse warming
similarity_max: 0.12
...
theme: "Nothing significant erupted into the news cycle this week on the volcanic-climate front — which makes it a good moment t"
---
...
On June 15, 1991, Mount Pinatubo in the Philippines injected an estimated 20 million metric tons of sulfur dioxide into the stratosphere in a single afternoon. By 1992, global mean surface temperatures had dropped roughly 0.5°C. That half-degree looks modest on paper. In climate terms, it temporarily offset nearly the entire warming trend accumulated since the mid-20th century.
