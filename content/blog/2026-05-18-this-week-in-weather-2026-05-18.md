...
opener_hash: fde2d8f4
key_phrases:
  - six tornado warnings in 13 minutes across north-central Iowa
  - "sharpest single-cluster sequence in this week's dataset"
  - swath stretching from the Missouri River bluffs northeast into lake country
  - "wind-dominant outbreak pattern — squall lines rather than discrete supercells driving most of the damage"
  - 231 hail reports against 692 wind reports
  - trough itself digs toward the Four Corners
  - shortwave rotating around the base of the trough and lifting into the Ohio Valley
  - blocking high over Scandinavia has been the primary driver of anomalous warmth across northwestern Europe
  - Sanriku coast has produced significant aftershock sequences historically
  - Kp at 0 and no Earth-directed CMEs on record
similarity_max: 0.82
...
![Cloud-to-ground lightning strike captured by NOAA.](https://commons.wikimedia.org/wiki/Special:FilePath/Lightning_NOAA.jpg?width=1280)
*NOAA*
...
![A GOES-16 mesoscale sector image showing a line of convective cells tracking northeast across Iowa, with overshooting tops visible in the infrared channel](https://placehold.co/800x450?text=GOES-16+Iowa+Convection+May+17)
...
![A 500 hPa geopotential height analysis valid for May 19, 2026, showing a trough axis over the central Rockies and downstream ridging toward the Atlantic](https://placehold.co/800x450?text=500+hPa+Analysis+May+19)
...
![A surface analysis chart for the UK and northwestern Europe showing a blocking high centered near Scandinavia and anomalously warm air advecting into the British Isles](https://placehold.co/800x450?text=UK+Surface+Analysis+May+19)
